...
%>
		...
		<tr><th>护卫队值班</th><td><span class="zszbz"><%=dantian(hwd,sj)%></span></td><th>司机值班</th><td colspan="2"><span class="zszbz"><%=dantian(sji,sj)%></span></td><th>水电班值班</th><td><span class="zszbz"><%=dantian(sdb,sj)%></span></td></tr>
